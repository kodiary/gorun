...
class HTMLPurifier_Generator
{
    ...
    /**
     * :HACK: Whether or not generator should comment the insides of <script type="text/javascript"> tags
     */
...
class HTMLPurifier_Lexer
{
    ...
    /**
     * Special CDATA case that is especially convoluted for <script type="text/javascript">
     */
...
class HTMLPurifier_Lexer_DOMLex extends HTMLPurifier_Lexer
{
    ...
    protected function createStartNode($node, &$tokens, $collect) {
        ...
        if ($node->nodeType === XML_TEXT_NODE) {
            ...
            // undo libxml's special treatment of <script type="text/javascript"> and <style> tags
            $last = end($tokens);
            $data = $node->data;
