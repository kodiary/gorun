...
class Club extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
            ...
            array('title,description,logo,types,venue,town,province,latitude,longitude,trial_day,trial_time,trial_desc,contact_person,website,fb_page,twitter_page','required','on'=>'create,dashboard.index'),
