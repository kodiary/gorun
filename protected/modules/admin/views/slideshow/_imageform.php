...
<li id="remove_<?php echo $index;?>">
  <div class="whitebg">
        <div class="buttons_for_img buttons fl_left sliderBtns" >
    ...
    //crop button
     echo CHtml::ajaxButton('Crop',
    	...
    	<div class="new-banner" >
        	<div class="" id="image_<?php echo $index?>"><?php echo CHtml::image(Yii::app()->baseUrl.'/images/sliderFallback.jpg');?></div>
        </div>
       
        <div class="submit_buttons_img fl_right">
        ...
        <div class="margintopbot10 slideLink">
            ...
            <?php echo CHtml::error($modelImages, "[$index]slide_link");?>
