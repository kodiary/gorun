<div class="service_listing">
         ...
         <div id="<?php echo $data->id?>" class="border_line service_list">
            ...
            <span class="titles"><?php echo $data->service_name?></span> - <a  href="javascript:void(0);" class="blue" onclick="$('#companies_<?php echo $data->id?>').toggle();"><?php echo CompanyServices::getServiceById($data->id).' Tags';?></a>
            </div>
         ...
         <div style="display: none;" id="show_<?php echo $data->id?>" class="warning_blocks">
                   ...
                   <?php $this->widget('bootstrap.widgets.BootButton', array(
                        //'fn'=>'ajaxLink',
                        'url' => $this->createUrl('deleteService', array('id'=>$data->id)),
                        'label'=>'Delete',
                        'type'=>'danger', // '', 'primary', 'info', 'success', 'warning', 'danger' or 'inverse'
...
<?php 
$list=CompanyServices::getCompanyByService($data->id);
if($list)
{
?>
