...
<div class="line"></div>
<h1>Add/Edit Events Type- <span class="blue">Create or Edit an Event Category here.</span></h1>
<div class="line"></div>
...
<div class="clear"></div>
 <div class="well"><?php echo $form->hiddenField($model,'id',array('readOnly'=>'readOnly')); ?>
	Category
	<?php echo $form->textField($model,'title',array('class'=>'span4','maxlength'=>255,'placeholder'=>'Enter Category','style'=>'margin-left:20px')); ?>
...
<ul id="subPages" class="ui-sortable">
 <?php
    ...
    foreach($records as $val){
        $count = EventsLink::countEventsLinkTags('category_id',$val->id);
    ?>
...
$(document).ready(function(){
   ...
   $('.btn-info').click(function(){
    ...
    if(id=val[1])
    {
        $.ajax({
          ...
          $("#EventsCategory_title").val(msg);
          $("#EventsCategory_id").val(id);
          $('#btnsubmit').html('Edit');
   ...
   $('#btncancel').live('click',function(){
        ...
        $("#EventsCategory_title").val('');
        $("#EventsCategory_id").val('');
        $(this).remove();
