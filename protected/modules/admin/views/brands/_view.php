<div class="brand_listing">
         ...
         <div id="<?php echo $data->id?>" class="border_line">
            ...
            <span class="titles"><?php echo $data->brand_name?></span> - <a  href="javascript:void(0);" class="blue" onclick="$('#companies_<?php echo $data->id?>').toggle();"><?php echo CompanyBrands::getBrandById($data->id).' Linked';?></a>
            </div>
         ...
         <div style="display: none;" id="show_<?php echo $data->id?>" class="warning_blocks">
                   ...
                   <?php $this->widget('bootstrap.widgets.BootButton', array(
                        //'fn'=>'ajaxLink',
                        'url' => $this->createUrl('deleteBrand', array('id'=>$data->id)),
                        'label'=>'Delete',
                        'type'=>'danger', // '', 'primary', 'info', 'success', 'warning', 'danger' or 'inverse'
...
<?php 
$list=CompanyBrands::getCompanyByBrand($data->id);
if($list)
{
?>
