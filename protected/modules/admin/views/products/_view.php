<div class="product_listing">
         ...
         <div id="<?php echo $data->id?>" class="border_line">
            ...
            <span class="titles"><?php echo $data->product_name?></span> - <a  href="javascript:void(0);" class="blue" onclick="$('#companies_<?php echo $data->id?>').toggle();"><?php echo CompanyProducts::getProductById($data->id).' Linked';?></a>
            </div>
         ...
         <div style="display: none;" id="show_<?php echo $data->id?>" class="warning_blocks">
                   ...
                   <?php $this->widget('bootstrap.widgets.BootButton', array(
                        //'fn'=>'ajaxLink',
                        'url' => $this->createUrl('deleteProduct', array('id'=>$data->id)),
                        'label'=>'Delete',
                        'type'=>'danger', // '', 'primary', 'info', 'success', 'warning', 'danger' or 'inverse'
...
<?php 
$list=CompanyProducts::getCompanyByProduct($data->id);
if($list)
{
?>
