...
$(document).ready(function(){
     var count='<?php echo PatronSlider::getMaxId(); ?> '; 
...
function initiateUpload(index)
{
    ...
    'debug':true,
    'multiple':false,
    'action':'<?php echo $this->createUrl("patronslider/upload/index");?>/'+index,
        ...
        $('#uploadControl_'+index).text('Browse');
            if(responseJSON.success)
            {
                ...
                else
                {
                    ...
                    $('#PatronSlider_'+index+'_image').val(responseJSON.filename);
                }
            }
            else
            {
