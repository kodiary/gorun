...
<div class="clear"></div>
 <div class="well"><?php echo $form->hiddenField($model,'id',array('readOnly'=>'readOnly')); ?>
	Types
	<?php echo $form->textField($model,'title',array('class'=>'span4','maxlength'=>255,'placeholder'=>'Enter Type','style'=>'margin-left:20px')); ?>
...
<ul id="subPages" class="ui-sortable">
 <?php
    ...
    foreach($records as $val){
        $count = EventsLink::countEventsLinkTags('type_id',$val->id);
    ?>
   ...
   $('.btn-info').click(function(){
    ...
    if(id=val[1])
    {
        $.ajax({
          ...
          $("#EventsType_title").val(msg);
          $("#EventsType_id").val(id);
          $('#btnsubmit').html('Edit');
