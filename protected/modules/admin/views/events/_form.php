...
<form action="<?php echo Yii::app()->request->baseUrl;?>/events/create/<?php if($model->id)echo $model->id;else echo '0';?>" id="profile-detail" method="post" onsubmit="return validate_form();">
                ...
                <div class="form-group white">
                    ...
                    <div class="col-md-12">Multiple Date Event &nbsp; <input type="checkbox" name="is_multiple_date" value="1" onchange="if($(this).is(':checked')){$('.hiddendate').show('slow');}else{$('#end_date').val('');$('.hiddendate').hide('slow');}" <?php if($model->end_date){?>checked<?php }?> /></div>
                    <div class="clearfix"></div>
                    <br />
