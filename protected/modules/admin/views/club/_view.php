...
<div class="member-listing border_line <?php echo $class; ?>">
    ...
    <?php echo CHtml::link('Edit',array('/admin/club/update/id/'.$data->id),array('class'=>'btn btn-info'))?>
...
<div id="div_del_<?php echo $data->id;?>" style="display: none;" class="warning_blocks">
    ...
    <div class="fl_right"><?php echo CHtml::link('Delete', array('/admin/club/delete/id/'.$data->id),array('class'=>'btn btn-danger'));?> <?php echo CHtml::link('Cancel','javascript:void(0);',array('onclick'=>'$("#div_del_'.$data->id.'").hide();','class'=>'btn'));?></div>
    <div class="clear"></div>
</div>