<div class="s_height_d">
    ...
    <div class="line"></div>
       <div class="companyList " style="margin:10px 0 0 0;">	
        	<div class="home left" > <a style="padding: 6px; margin-right: 10px;" href="<?php echo $this->createUrl('/admin/club');?>" class="btn"><i class="icon-home"></i></a> </div>
            <div class="blue_selects">
                <select onchange="if (this.value) window.location.href=this.value">
                <option value="">Select Club</option>
                <?php
                $companyList = Club::getAllClub();
                if($companyList)
                {
                    foreach($companyList as $val)
                    {?>
                        <option value="<?php echo $this->createUrl('/admin/club/update/id/'.$val->id);?>" <?php if($val->id==$model->id) echo "selected";?>><?php echo $val->title;?></option>
                    <?php }    
                }
                ?>
                </select>
    ...
    <!--dropdown menu end-->
        <div class="border-line pad15">
            <p class="f17"><?php echo ucwords($model->title); 
        ...
        <div class="gray_blocks borders active_or_not">
           ...
           <?php $form=$this->beginWidget('bootstrap.widgets.BootActiveForm',array(
            ...
            <div class="clear"></div>
            <div class="control-group"><label class="control-label" style="width: 160px; padding-top: 0; color:#000;" >Stats</label><span class="blue control">Added <?php echo date('d F Y');?></span></div>
            
            <div class="line"></div>
            <div class="sub_margin" style="padding-bottom:10px;">
                <?php echo CHtml::ajaxSubmitButton('Submit',
                        $this->createUrl('club/updatestatus/id/'.$model->id),
                         array( //ajax options
    ...
    <!--div class="col-md-4 memtype">
        <div class="fl_right" style="margin-left:5px;">
            <a class="btn" href="<?php echo $this->createUrl('club/contact/id/'.$model->id); ?>">Contact</a>
        </div>
        <div class="clear"></div>
