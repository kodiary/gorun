<div class="type_listing">

         <div id="<?php echo $data->id?>" class="border_line service_list">
        	<div class="text_desc_l">
            <span class="titles"><?php echo $data->type_name?></span> - <a  href="javascript:void(0);" class="blue" onclick="$('#companies_<?php echo $data->id?>').toggle();"><?php echo CompanyMember::getMemberTypeById($data->id).' Tags';?></a>
            </div>
         ...
         <div style="display: none;" id="show_<?php echo $data->id?>" class="warning_blocks">
                   ...
                   <?php $this->widget('bootstrap.widgets.BootButton', array(
                        //'fn'=>'ajaxLink',
                        'url' => $this->createUrl('deleteType', array('id'=>$data->id)),
                        'label'=>'Delete',
                        'type'=>'danger', // '', 'primary', 'info', 'success', 'warning', 'danger' or 'inverse'
...
<?php 
$list=CompanyMember::getCompanyByMemberType($data->id);
if($list)
{
?>
