...
<div id="uploadFile">
    <div class="qq-uploader" >
        ...
        <div class="image_rows">
        	<div class="qq-upload-button qq-upload-image-button left" id="<?php echo $index;?>" style="position: relative; overflow: hidden; direction: ltr;" ><span class="uploadControl">Add Photos</span>
        ...
        <div class="blue left">Add one or more</div>
        <div class="clear"></div>
        ...
        foreach($model as $i=>$model_image){ ?>
            <li class="items" id="image_<?php echo $i; ?>">
                <?php if($model_image){ ?>
                    ...
                    <div id="imageHolder_<?php echo $i;?>"><img class="thumbnail left" src="<?php echo $this->createUrl('/images/frontend/thumb/'.$model_image->filename)?>"/></div>
                    <div class="new-btns">
                    <a href="javascript:void(0);" class="btn btn-danger" onclick="$('#image_<?php echo $i;?>').remove();">Remove</a>
                        <?php
                        //crop button
                    ...
                    <?php echo CHtml::activeTextArea($model_image,"[$i]title",array('placeHolder'=>'Caption', 'class'=>'')); ?>
