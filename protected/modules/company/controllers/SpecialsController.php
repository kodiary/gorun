...
class SpecialsController extends Controller
{
	 ...
	 */
	public function actionDelete($specId)
	{
        $id = Yii::app()->user->id;
		if($id)
		{
    ...
    function actionCropLogo()
    {
        if($_POST['fileName']!="")
        {
        	...
        	$this->renderPartial('application.modules.admin.views.specials._cropImg', array('imageUrl'=>$imageUrl,'image'=>$_POST['fileName']), false, true);
         }
         else
            echo "";
    } 
