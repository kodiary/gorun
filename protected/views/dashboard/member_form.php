<div class="member_form">
    ...
    <hr />
    <form action="" id="profile-detail" method="post">
        ...
        <div class="form-group">
            ...
            <?php echo $this->renderPartial('application.views.gallery._addImage',array('model'=>$member,'type'=>'member')); ?>
    ...
    //crop button
     echo CHtml::ajaxLink('<span class="fa fa-crop"></span> Crop',
                Yii::app()->baseUrl.'/gallery/cropPhoto?height=215&width=215&img-circle',
                 array( //ajax options
    ...
    ?><br />
        ...
        <div class="form-group">
            ...
            <div class="col-md-6 picact">
            <?php echo $this->renderPartial('application.views.gallery._addImagecover',array('model'=>$member,'type'=>'member_cover','id'=>1)); ?>
    ...
    //crop button
     echo CHtml::ajaxLink('<span class="fa fa-crop"></span> Crop',
                Yii::app()->baseUrl.'/gallery/cropPhoto?height=220&width=760&crop_cover=cover',
                 array( //ajax options
