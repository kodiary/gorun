...
<tr title="<?php echo $offset;?>">
    ...
    <td><span class="blue"><a href="<?php echo Yii::app()->request->baseUrl."/events/view/".$result->event['slug'];?>" target="_blank"><?php echo date("d M Y",strtotime($result->result_date));?></span></td>
</tr>
<?php
}
?>