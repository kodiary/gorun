...
<form action="<?php echo $url;?>" id="club-detail" method="post">
    ...
    <div class="form-group white">
        ...
        <div class="col-md-12">
            <input type="text" class="form-control" placeholder="Your Club Name" name="title" value="<?php if(isset($model))echo $model->title;?>" />
      ...
      <div class="form-group white">
        ...
        <div class="col-md-12">
            <?php
            if(isset($model) &&$model->types)
                $event_array = explode(',',$model->types);
            foreach($events as $event)
            {?>
                <div class="col-md-6 checkboxes">
                    <label class="control control--checkbox"><?php echo $event->title;?>
                      <input type="checkbox" name="type[]" value="<?php echo $event->id."_".$event->cat_id;?>" <?php echo (isset($event_array)&& in_array($event->id,$event_array))?"checked='checked'":'';?> />
    ...
    <div class="form-group white">
        ...
        <div class="col-md-12"><textarea class="form-control description" name="description" placeholder="Club details here ..." ><?php if(isset($model))echo $model->description;?></textarea></div>
        <div class="clearfix"></div>
...
//crop button
 echo CHtml::ajaxLink('<span class="fa fa-crop"></span> Crop',
            Yii::app()->baseUrl."/gallery/cropPhoto?height=180&width=220",
            //$this->createUrl('gallery/cropPhoto?height=180&width=220'),
             array( //ajax options
             'data'=>array('fileName'=>"js:function(){ return $('.uploaded_image').val()}",'id'=>(isset($member))?$member->id:'9999'),
             'type'=>'POST',
     ...
     <div class="form-group white">
        ...
        <br /><span class="blue">Size is 760x220px</span></label>
         <div class="col-md-12 profilepic">
            ...
            if(isset($model)){
                if($model->cover!='' && (Yii::app()->basePath.'/../images/frontend/thumb/'.$model->cover))
                {
        ...
        <div class="col-md-6 picact" >
            ...
            //crop button
                echo CHtml::ajaxLink('<span class="fa fa-crop"></span> Crop',
                        array('/gallery/cropPhoto?height=220&width=760&crop_cover=cover'),
                         array( //ajax options
                         'data'=>array('fileName'=>"js:function(){ return $('.uploaded_cover').val()}",'id'=>(isset($member))?$member->id:'admincover'),
                         'type'=>'POST',
                        'success'=>"js:function(data){
                                    if(data!=''){
  ...
  id="country" disabled="true"/></td>
    ...
    <div class="form-group white">
          ...
          <div class="form-group">
            ...
            <?php $provinces = Province::model()->findAll();
                foreach($provinces as $province){?>
                    <option value="<?php echo $province->id;?>" <?php echo ($province->id==$model->province)?"selected='selected'":'';?>><?php echo $province->name;?></option>
            <?php }?>
        ...
        <div class="form-group">
            ...
            <div class="col-md-7"><input type="text" id="city" class="form-control" placeholder="Closest City or Town" name="city" value="<?php if(isset($model) )echo $model->town;?>" onBlur='codeAddress();' /></div>
            <div class="clearfix"></div>
        </div>
        <div class="clearfix"></div>
      </div>
    ...
    <div class="form-group ">
        ...
        <div class="col-md-10"><input type="text" id="Company_street_add" class="form-control" placeholder="Enter Venue Name or Street Address" onFocus="geolocate()" name="street_address" value="<?php if(isset($model) )echo $model->venue;?>" /></div>
            ...
            <div class="controls col-md-7">
                <div class="sn_group">
                	<div class="s1 col-md-3 padding-left-0">
                        <input type="text" class="form-control" name="latitude" id="Company_latitude" value="<?php if(isset($model) )echo $model->latitude;?>" placeholder="Latitude" style="width:127px;" onblur="updateMapPinPosition()"/>
                    <?php //echo $form->textField($model, 'latitude',array('placeholder'=>'Latitude','style'=>'','onBlur'=>'updateMapPinPosition();') );?>
                    </div>
                    <div class="s2 col-md-3">
                        <input type="text" class="form-control" name="longitude" id="Company_longitude" value="<?php if(isset($model) )echo $model->longitude;?>" placeholder="Longitude" style="width:125px;margin-left:50px;;" onblur="updateMapPinPosition()"/>
    ...
    <!--div class="form-group white">
        ...
        <div class="form-group">
            ...
            <div class="col-md-7"><input type="text" class="form-control" placeholder="Optional description" name="trial_desc" value="<?php //echo $model->fname;?>" /></div>
            <div class="clearfix"></div>
    ...
    <div class="form-group white">
        ...
        <div class="Contact_Number">
            <div class="form-group">
                ...
                <div class="col-md-6"><input type="text" class="form-control" placeholder="Contact Number" name="contact_number" value="<?php if(isset($model) )echo $model->contact_number;?>" /></div>
        ...
        <div class="Contact_Email">
            <div class="form-group ">
                ...
                <div class="col-md-6"><input type="text" class="form-control" placeholder="Contact Email" name="contact_email" value="<?php if(isset($model) )echo $model->contact_email;?>" /></div>
      ...
      <div class="form-group">
        ...
        <div class="col-md-6"><input type="url" class="form-control" placeholder="Organiser Website Address" name="website" value="<?php if(isset($model) )echo $model->website;?>" /></div>
        <div class="clearfix"></div>
    ...
    <div class="white form-group">
        ...
        <div class="form-group">
            ...
            <div class="col-md-6"><input type="url" class="form-control" placeholder="http://" name="fb_page" value="<?php if(isset($model) )echo $model->fb_page;?>" /></div>
            <div class="clearfix"></div>
        ...
        <div class="form-group">
            ...
            <div class="col-md-6"><input type="url" class="form-control" placeholder="http://" name="twitter_page" value="<?php if(isset($model) )echo $model->twitter_page;?>" /></div>
            <div class="clearfix"></div>
         ...
         <div class="form-group">
            ...
            <div class="col-md-6"><input type="url" class="form-control" placeholder="http://" name="google" value="<?php if(isset($model) )echo $model->google;?>" /></div>
            <div class="clearfix"></div>
